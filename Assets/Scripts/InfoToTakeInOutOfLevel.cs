...
public class InfoToTakeInOutOfLevel : MonoBehaviour {
    ...
    private string sceneNameOfLevel;
    ...
    public void setSceneNameOfLevel(string name)
    {
        sceneNameOfLevel = name;
    }
    public string getSceneNameOfLevel()
    {
        return sceneNameOfLevel;
    }
