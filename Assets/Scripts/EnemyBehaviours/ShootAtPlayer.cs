	...
	void Update ()
    {
        if (player.GetComponent<PlayerControllerScript>().isInAllRange())
        {
            ...
            if (Time.time - timeOfLastShot > timeBetweenShots)
            {
                ...
                timeToReachPlayer = -1 * ((((shotSpeed * (player.transform.position.z + distanceToLeadShot) - player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.z * transform.position.z) / (shotSpeed - player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.z)) - player.transform.position.z + distanceToLeadShot) / player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.z);
                timeToReachPlayer2 = -1 * ((((shotSpeed * (player.transform.position.x + distanceToLeadShot) - player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.x * transform.position.x) / (shotSpeed - player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.x)) - player.transform.position.x + distanceToLeadShot) / player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.x);
                timeToReachPlayer3 = -1 * ((((shotSpeed * (player.transform.position.y + distanceToLeadShot) - player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.y * transform.position.y) / (shotSpeed - player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.y)) - player.transform.position.y + distanceToLeadShot) / player.GetComponent<PlayerControllerScript>().getCurrentSpeed() * normDirection.y);
